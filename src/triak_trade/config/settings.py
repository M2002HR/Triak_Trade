...
class Settings(BaseSettings):
    ...
    LIVE_TRADING_ACCOUNT_POSITION_POLICY: Literal["net", "hedge", "block"] = "net"
    LIVE_TRADING_SAME_DIRECTION_POLICY: Literal["aggregate", "block"] = "aggregate"
    LIVE_TRADING_SYMBOL_RISK_CAP_PCT_OF_BALANCE: Decimal = Decimal("5")
    LIVE_TRADING_DUPLICATE_SIGNAL_WINDOW_SECONDS: int = 300
    LIVE_TRADING_DUPLICATE_PRICE_TOLERANCE_BPS: Decimal = Decimal("20")
    LIVE_TRADING_USE_OWNED_V2_STOP_ORDERS: bool = True
    ...
    LIVE_TRADING_STARTUP_REPLAY_SECONDS: int = 180
    LIVE_TRADING_STARTUP_HISTORY_LIMIT: int = 5
