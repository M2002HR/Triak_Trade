...
def test_env_example_matches_selected_settings_defaults() -> None:
    ...
    expected = {
        ...
        "ISOLATED_BACKTEST_MAX_CANDLES_PER_SYMBOL": str(
            settings.ISOLATED_BACKTEST_MAX_CANDLES_PER_SYMBOL
        ),
        "ISOLATED_BACKTEST_MARKET_DATA_TIMEOUT_SECONDS": str(
            settings.ISOLATED_BACKTEST_MARKET_DATA_TIMEOUT_SECONDS
        ),
        "ISOLATED_BACKTEST_MARKET_DATA_MAX_CONCURRENCY": str(
            settings.ISOLATED_BACKTEST_MARKET_DATA_MAX_CONCURRENCY
        ),
