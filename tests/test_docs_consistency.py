...
def test_env_example_matches_selected_settings_defaults() -> None:
    ...
    expected = {
        ...
        "BACKTEST_MAX_CANDLES_PER_SYMBOL": str(
            settings.BACKTEST_MAX_CANDLES_PER_SYMBOL
        ),
        "BACKTEST_MARKET_DATA_TIMEOUT_SECONDS": str(
            settings.BACKTEST_MARKET_DATA_TIMEOUT_SECONDS
        ),
        "BACKTEST_MARKET_DATA_MAX_CONCURRENCY": str(
            settings.BACKTEST_MARKET_DATA_MAX_CONCURRENCY
        ),
